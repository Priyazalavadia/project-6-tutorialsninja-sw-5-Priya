...
public class HomePage extends Utility {
    ...
    public void mouseHoverOnDesktopsLinkAndClick() {
        CustomListeners.test.log(Status.PASS,"Mouse Hoover On Desktop");
        mouseHoverToElementAndClick(desktopLink);
    }

    public void mouseHoverOnLaptopsAndNotebooksLinkAndClick() {
        CustomListeners.test.log(Status.PASS,"Mouse Hoover On Laptops and Notebooks");
        mouseHoverToElementAndClick(laptopsAndNotebooksLink);
    }

    public void mouseHoverOnComponentLinkAndClick() {
        CustomListeners.test.log(Status.PASS,"Mouse Hoover On Component");
